...
-- Generado: 2026-06-11T11:22:16.037521
...
INSERT INTO [dbo].[areas_area] ([id], [nombre], [descripcion], [estado], [usuario_responsable_area_id], [trial174], [TRIAL393])
VALUES
...
INSERT INTO [dbo].[auth_permission] ([id], [content_type_id], [codename], [name], [trial177], [TRIAL396])
VALUES
...
VALUES
    ...
    (121, 31, 'add_proyectosecretaria', 'Can add proyecto secretaria', NULL, NULL),
    (122, 31, 'change_proyectosecretaria', 'Can change proyecto secretaria', NULL, NULL),
    (123, 31, 'delete_proyectosecretaria', 'Can delete proyecto secretaria', NULL, NULL),
    (124, 31, 'view_proyectosecretaria', 'Can view proyecto secretaria', NULL, NULL);
...
INSERT INTO [dbo].[backup_restore_activesession] ([id], [last_activity], [session_key], [user_id], [trial180], [TRIAL399])
VALUES
    ...
    (165, '2026-03-19 18:38:50', 'sess_1773944810541_rl915ucsbd', 18, NULL, NULL),
    (169, '2026-03-26 18:30:46', 'sess_1774531044603_5gdtlqzm2c', 6, NULL, NULL),
    (181, '2026-03-27 15:54:47', 'sess_1774626646555_unzuz0mn41', 19, NULL, NULL),
    (187, '2026-03-27 18:58:29', 'sess_1774637910596_lu3713mnad', 6, NULL, NULL),
    (188, '2026-03-27 19:51:15', 'sess_1774641075009_o2c4gxtgaa', 6, NULL, NULL),
    (189, '2026-03-27 20:01:59', 'sess_1774641719367_8ynye2odhk', 6, NULL, NULL),
    (192, '2026-03-27 22:11:54', 'sess_1774645069403_67uorlal51', 19, NULL, NULL),
    (193, '2026-03-27 22:16:12', 'sess_1774649752632_04cx1l97a5', 6, NULL, NULL),
    (196, '2026-03-28 13:54:41', 'sess_1774706081288_yihnzhqqmv', 6, NULL, NULL),
    (197, '2026-03-28 14:34:33', 'sess_1774708472761_m1v364aa8b', 6, NULL, NULL),
    (199, '2026-03-28 14:47:17', 'sess_1774708638631_ytcn7xpn8g', 6, NULL, NULL),
    (206, '2026-03-30 20:03:33', 'sess_1774887763753_vyte4wgbgk', 6, NULL, NULL),
    (213, '2026-04-01 17:23:10', 'sess_1775063828504_8tyo3aysp5', 6, NULL, NULL),
    (215, '2026-04-01 17:30:44', 'sess_1775064404400_uip32953t1', 6, NULL, NULL),
    (217, '2026-04-01 17:29:51', 'sess_1775064592293_0y07j20dd3', 6, NULL, NULL),
    (218, '2026-04-01 18:06:51', 'sess_1775066211673_e2daepi1s2', 6, NULL, NULL),
    (221, '2026-04-04 12:31:01', 'sess_1775305861304_cznox2x92z', 6, NULL, NULL),
    (225, '2026-04-09 19:45:07', 'sess_1775500349122_nabs8ca5ef', 6, NULL, NULL),
    (226, '2026-04-08 05:43:51', 'sess_1775598328801_j685jhaj4k', 6, NULL, NULL),
    (229, '2026-04-12 00:12:52', 'sess_1775952771919_6n69o1g9ho', 6, NULL, NULL),
    (232, '2026-04-13 14:31:08', 'sess_1776085684720_dj3hifo8iv', 6, NULL, NULL),
    (237, '2026-05-27 19:10:45', 'sess_1779901915047_22212veuzn', 6, NULL, NULL),
    (238, '2026-05-29 18:52:16', 'sess_1780058050611_cdnyvunfwk', 6, NULL, NULL),
    (240, '2026-06-03 19:04:08', 'sess_1780492772263_e2a7b7m3om', 6, NULL, NULL),
    (242, '2026-06-05 19:42:59', 'sess_1780668988072_gis64wa0a7', 6, NULL, NULL),
    (245, '2026-06-09 19:22:40', 'sess_1781023793892_2ke2313fut', 6, NULL, NULL),
    (248, '2026-06-10 00:39:42', 'sess_1781044999307_dvyrpdvyu4', 19, NULL, NULL),
    (253, '2026-06-10 14:40:04', 'sess_1781099874098_6lp24a7zur', 25, NULL, NULL),
    (259, '2026-06-11 13:35:28', 'sess_1781183340407_ssx424kgdg', 6, NULL, NULL),
    (260, '2026-06-11 14:21:33', 'sess_1781185135476_fxctmr5pff', 6, NULL, NULL);

SET IDENTITY_INSERT [dbo].[backup_restore_activesession] OFF;
GO

SET IDENTITY_INSERT [dbo].[backup_restore_systemrestorelog] ON;
INSERT INTO [dbo].[backup_restore_systemrestorelog] ([id], [backup_file], [executed_at], [ip_address], [user_id], [trial180], [TRIAL403])
VALUES
...
INSERT INTO [dbo].[django_content_type] ([id], [app_label], [model], [trial180], [TRIAL403])
VALUES
    ...
    (31, 'projects', 'proyectosecretaria', NULL, NULL);

SET IDENTITY_INSERT [dbo].[django_content_type] OFF;
GO

SET IDENTITY_INSERT [dbo].[django_migrations] ON;
INSERT INTO [dbo].[django_migrations] ([id], [app], [name], [applied], [trial180], [TRIAL406])
VALUES
    ...
    (55, 'projects', '0014_proyectosecretaria', '2026-04-01 18:09:20', NULL, NULL),
    (56, 'projects', '0015_proyecto_es_transversal', '2026-04-01 18:09:20', NULL, NULL);
...
INSERT INTO [dbo].[projects_adjuntoauditlog] ([id], [tipo], [adjunto_id], [accion], [fecha], [nombre_archivo], [nombre_anterior], [nombre_nuevo], [proyecto_id], [tarea_id], [usuario_id], [trial183], [TRIAL406])
VALUES
...
INSERT INTO [dbo].[projects_comentarioauditlog] ([id], [tipo], [comentario_id], [accion], [fecha], [texto_anterior], [texto_nuevo], [proyecto_id], [tarea_id], [usuario_id], [trial183], [TRIAL409])
VALUES
...
INSERT INTO [dbo].[projects_comentarioproyecto] ([id], [texto], [fecha], [proyecto_id], [usuario_id], [editado_por_id], [fecha_edicion], [trial183], [TRIAL409])
VALUES
...
INSERT INTO [dbo].[projects_eje] ([id_eje], [nombre_eje], [trial187], [TRIAL409])
VALUES
...
INSERT INTO [dbo].[projects_objetivoestrategico] ([id], [descripcion], [programa_id], [trial187], [TRIAL412])
VALUES
    ...
    (32, 'cambiar da datos', '1.1', NULL, NULL);

SET IDENTITY_INSERT [dbo].[projects_objetivoestrategico] OFF;
GO

SET IDENTITY_INSERT [dbo].[projects_plan] ON;
INSERT INTO [dbo].[projects_plan] ([id_plan], [nombre_plan], [proposito_politica_publica], [vision_estrategica], [eje_id], [trial187], [TRIAL412])
VALUES
...
INSERT INTO [dbo].[projects_programa] ([id_programa], [nombre_programa], [plan_id], [trial187], [TRIAL412])
VALUES
...
INSERT INTO [dbo].[projects_proyecto] ([id], [nombre], [descripcion], [fecha_inicio], [fecha_fin_estimada], [fecha_fin_real], [estado], [porcentaje_avance], [fecha_creacion], [creado_por_id], [programa_id], [objetivo_estrategico_id], [secretaria_id], [usuario_responsable_id], [area_id], [trial187], [fuente_financiamiento], [presupuesto_total], [TRIAL416], [es_transversal])
VALUES
    (11, 'Prácticas Profesionalizantes Colegio antonio marte', 'Prácticas Profesionalizantes Colegio antonio marte , prácticas reales 2026 para los alumnos.', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 15:25:19', 6, NULL, NULL, 7, 21, NULL, 'T', 'Sin Erogacion', '0.00', 'T', 0),
    (70, 'PLAN DE FORMACIÓN INTERNA- ADOPCIÓN DE IA', 'El Plan de Adopción de IA trasciende la modernización administrativa; nace con la ambición de consolidar a la provincia de Tierra del Fuego, Antártida e Islas del Atlántico Sur como un faro de innovación en el contexto nacional y subantártico. Bajo la premisa de la soberanía tecnológica, el plan se articula en cuatro ejes que transforman nuestra identidad geográfica en una ventaja competitiva digital.', '2026-04-13', '2026-05-29', NULL, 'Activo', 0.0, '2026-04-14 19:19:08', 19, NULL, NULL, NULL, 20, 1, NULL, 'Sin Erogacion', '0.00', NULL, 1),
    (71, 'IATHON', '', '2026-06-10', '2026-06-12', NULL, 'Activo', 0.0, '2026-06-09 16:43:28', 19, NULL, NULL, 7, 20, NULL, NULL, 'Provincial', '0.00', NULL, 1),
    (14, 'Pasantías No Rentadas 6to Año - Colegio kloketen', 'Pasantías No Rentadas 6to Año - Colegio kloketen', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 17:33:36', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (16, 'Plan de Capacitación Cisco 2026', 'Plan de Capacitación Cisco 2026', '2026-03-02', '2026-12-31', NULL, 'Activo', 0.0, '2026-03-02 17:44:39', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (18, 'PFI 2026: Proyecto Manejo del Fuego', 'PFI 2026: Proyecto Manejo del Fuego', '2026-03-02', '2026-03-28', NULL, 'Activo', 0.0, '2026-03-02 17:58:38', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (19, 'Regularización Administrativa IDE (Expediente)', 'Regularización Administrativa IDE (Expediente)', '2026-03-02', '2026-03-28', NULL, 'Activo', 0.0, '2026-03-02 18:03:31', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (21, 'Gestión de RRHH: Reducción Horaria', 'Gestión de RRHH: Reducción Horaria', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 18:15:37', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (22, 'Revisión y Ajuste de Horarios Polos', 'Revisión y Ajuste de Horarios Polos', '2026-03-02', '2026-07-30', NULL, 'Activo', 0.0, '2026-03-02 18:20:34', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (24, 'Plataforma Educativa FP', 'Plataforma Educativa FP (Ever)', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 18:52:09', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (25, 'TDR Formación Profesional Videojuegos', 'TDR Formación Profesional Videojuegos', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 18:56:03', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (26, 'Convenio Marco de Educación', 'Convenio Marco de Educación (Fernanda)', '2026-03-02', '2026-03-28', NULL, 'Activo', 0.0, '2026-03-02 18:58:35', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (28, 'Simposio 2026 Agencia de Innovación', 'Simposio 2026 Agencia de Innovación', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:04:29', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (29, 'Reunión IPAP 15 de Marzo (Egresados TS)', 'Reunión IPAP 15 de Marzo (Egresados TS)', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:07:27', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (30, 'Ampliación de Prácticas Profesionales (Anexo 11)', 'Ampliación de Prácticas Profesionales (Anexo 11)', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:09:47', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (31, 'Proyecto Biotecnología', 'Proyecto Biotecnología', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:13:13', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (32, 'Agenda Semana de Malvinas', 'Agenda Semana de Malvinas', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:18:09', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (33, 'Semana de la Creatividad e Innovación (21 de Abril)', 'Semana de la Creatividad e Innovación (21 de Abril)', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:22:23', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (34, 'Convenio Jala University', 'Convenio Jala University', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:25:43', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (35, 'Acción Comunitaria "Estudia con Malvina"', 'Acción Comunitaria "Estudia con Malvina"', '2026-03-02', '2026-03-28', NULL, 'Activo', 0.0, '2026-03-02 19:28:27', 6, NULL, NULL, 7, 20, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (36, 'TDR Segunda Fase Matemática (Malvina)', 'TDR Segunda Fase Matemática (Malvina)', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:33:35', 6, NULL, NULL, 7, 20, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (37, 'Sistema de Rendiciones COFECYT', 'Sistema de Rendiciones COFECYT', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:36:41', 6, NULL, NULL, 7, 20, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (38, 'Aplicación Registro y Base de Datos', 'Aplicación Registro y Base de Datos (Horacio)', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:39:25', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (39, 'Proyecto Piloto Jóvenes y Adultos (EPS)', 'Proyecto Piloto Jóvenes y Adultos (EPS)', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:42:11', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (40, 'Formación en IA para Asesores Pedagógicos', 'Formación en IA para Asesores Pedagógicos', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:44:27', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (41, 'Plan Provincial de Inteligencia Artificial (PIPIA)', 'Plan Provincial de Inteligencia Artificial (PIPIA)', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:47:17', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (42, 'Plan de Turismo Científico 2026', 'Plan de Turismo Científico 2026', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:49:45', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (43, 'Producción del Streaming "Ciencia en Fuego"', 'Producción del Streaming "Ciencia en Fuego"', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:52:09', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (44, 'Actualización de diseño de los Diarios de Campo', 'Actualización de diseño de los Diarios de Campo', '2026-03-02', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-02 19:55:18', 6, NULL, NULL, 7, 9, NULL, 'T', 'Provincial', '0.00', 'T', 0),
    (54, 'Desembolso de fondos de Nación (2do)', 'Desembolso de fondos de Nación (2do)', '2026-03-06', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-06 13:51:27', 13, NULL, NULL, 7, 9, NULL, NULL, 'Provincial', '0.00', 'T', 0),
    (52, 'Articulación con Instituciones - Talleres', 'Articulación con Instituciones - Talleres', '2026-03-06', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-06 16:26:27', 13, NULL, NULL, 7, 9, NULL, NULL, 'Provincial', '0.00', 'T', 0),
    (53, 'Vinculación con BOUNDY EDTECH APP', 'Vinculación con BOUNDY EDTECH APP', '2026-03-06', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-06 16:43:57', 13, NULL, NULL, 7, 9, NULL, NULL, 'Provincial', '0.00', 'T', 0),
    (55, 'RESOLVER CONVENIO CON CADIC', 'RESOLVER CONVENIO CON CADIC', '2026-03-06', '2026-06-30', NULL, 'Activo', 0.0, '2026-03-06 14:09:32', 13, NULL, NULL, 7, 9, NULL, NULL, 'Provincial', '0.00', 'T', 0),
    (69, 'Articulación con el Ministerio de Educación para la Transformación Educativa (Hito Central):', 'Articulación con el Ministerio de Educación para la Transformación Educativa (Hito Central):', '2026-03-17', '2026-03-21', NULL, 'Activo', 0.0, '2026-03-16 14:50:21', 6, NULL, NULL, 7, 17, NULL, NULL, 'CFI', '23552000.00', 'T', 0);

SET IDENTITY_INSERT [dbo].[projects_proyecto] OFF;
GO

SET IDENTITY_INSERT [dbo].[projects_proyectoarea] ON;
INSERT INTO [dbo].[projects_proyectoarea] ([id], [area_id], [proyecto_id], [trial187], [TRIAL416])
VALUES
    (1, 1, 70, NULL, NULL),
    (2, 2, 70, NULL, NULL),
    (3, 3, 70, NULL, NULL),
...
SET IDENTITY_INSERT [dbo].[projects_proyectoarea] OFF;
GO

SET IDENTITY_INSERT [dbo].[projects_proyectoequipo] ON;
INSERT INTO [dbo].[projects_proyectoequipo] ([id], [proyecto_id], [usuario_id], [trial190], [TRIAL416])
VALUES
    (1, 11, 6, NULL, NULL);

SET IDENTITY_INSERT [dbo].[projects_proyectoequipo] OFF;
GO

INSERT INTO [dbo].[projects_proyectopresupuestoitem] ([id], [categoria_gasto], [monto], [detalle], [numero_expediente], [es_viaticos], [dotacion_tipo], [horas_hombre], [orden], [proyecto_id], [TRIAL419])
VALUES
...
SET IDENTITY_INSERT [dbo].[projects_proyectosecretaria] ON;
INSERT INTO [dbo].[projects_proyectosecretaria] ([id], [proyecto_id], [secretaria_id])
VALUES
    (4, 11, 7),
    (5, 35, 7),
    (6, 36, 7),
...
SET IDENTITY_INSERT [dbo].[projects_proyectosecretaria] OFF;
GO

SET IDENTITY_INSERT [dbo].[secretarias_secretaria] ON;
INSERT INTO [dbo].[secretarias_secretaria] ([id], [codigo], [nombre], [descripcion], [activa], [fecha_creacion], [fecha_modificacion], [usuario_creacion], [usuario_modificacion], [trial190], [TRIAL419])
VALUES
    (6, 'ADM', 'Innovación Administrativa', 'Secretaría de gestión institucional', 0, '2026-03-02 11:05:44', '2026-06-09 16:59:58', '', '', 'T', 'T'),
    (4, 'CUL', 'Cultura', 'Secretaría de promoción cultural y desarrollo creativo', 0, '2026-03-02 02:05:44', '2026-06-09 16:59:58', '', '', 'T', 'T'),
    (2, 'CYT', 'Ciencia y Tecnología', 'Secretaría orientada a la investigación científica y desarrollo tecnológico', 0, '2026-03-02 05:05:44', '2026-06-09 16:59:58', '', '', 'T', 'T'),
    (1, 'EC', 'Economía del Conocimiento', 'Secretaría orientada al desarrollo del sector tecnológico y economía basada en conocimiento', 0, '2026-03-01 23:05:44', '2026-06-09 16:59:58', '', '', 'T', 'T'),
    ...
    (5, 'GOB', 'Gobierno Abierto', 'Secretaría de modernización y transparencia', 0, '2026-03-02 02:05:44', '2026-06-09 17:01:16', '', '', 'T', 'T'),
    (22, 'IP', 'IPAP', 'Instituto Provincial de Administración Pública', 1, '2026-06-09 16:58:47', '2026-06-09 16:58:47', '', '', NULL, NULL),
    (23, 'IP', 'IPAP', 'Instituto Provincial de Administración Pública', 0, '2026-06-09 16:58:47', '2026-06-09 16:59:58', '', '', NULL, NULL),
    (24, 'IPAP', 'IPAP', 'Instituto Provincial de Administración Pública', 0, '2026-06-09 16:58:47', '2026-06-09 16:59:58', '', '', NULL, NULL),
    ...
    (3, 'TEC', 'Tecnología', 'Secretaría de innovación y transformación digital', 1, '2026-03-02 02:05:44', '2026-03-18 13:25:26', '', '', 'T', 'T');

SET IDENTITY_INSERT [dbo].[secretarias_secretaria] OFF;
GO

INSERT INTO [dbo].[sqlite_sequence] ([name], [seq], [trial190], [TRIAL419])
VALUES
...
INSERT INTO [dbo].[tasks_adjuntotarea] ([id], [archivo], [nombre_original], [fecha], [subido_por_id], [tarea_id], [trial190], [TRIAL419])
VALUES
...
INSERT INTO [dbo].[tasks_comentariotarea] ([id], [texto], [fecha], [tarea_id], [usuario_id], [editado_por_id], [fecha_edicion], [trial190], [TRIAL422])
VALUES
...
INSERT INTO [dbo].[tasks_historialtarea] ([id], [comentario], [porcentaje_avance], [fecha], [tarea_id], [usuario_id], [porcentaje_anterior], [trial193], [TRIAL422])
VALUES
...
INSERT INTO [dbo].[tasks_tarea] ([id], [titulo], [descripcion], [fecha_inicio], [fecha_vencimiento], [estado], [porcentaje_avance], [prioridad], [fecha_creacion], [area_id], [etapa_id], [responsable_id], [secretaria_id], [proyecto_id], [tarea_padre_id], [trial193], [orden], [TRIAL422])
VALUES
    (28, 'Redactar nota de elevación con las 4 ofertas integradoras', 'Redactar nota de elevación con las 4 ofertas integradoras', '2026-03-02', '2026-03-06', 'Finalizada', 100, 'Media', '2026-03-02 15:31:43', NULL, NULL, 20, 7, 11, NULL, 'T', 0, 'T'),
    (29, 'Enviar el proyecto formal a la dirección de la escuela.', 'Enviar el proyecto formal a la dirección de la escuela.', '2026-03-02', '2026-03-06', 'Finalizada', 100, 'Media', '2026-03-02 15:32:50', NULL, NULL, 21, 7, 11, NULL, 'T', 0, 'T'),
    (30, 'Definir topes de estudiantes por proyecto y criterios de renovación.', 'Definir topes de estudiantes por proyecto y criterios de renovación.', '2026-03-02', '2026-03-06', 'Finalizada', 100, 'Media', '2026-03-02 15:33:29', NULL, NULL, 21, 7, 11, NULL, 'T', 0, 'T'),
    (31, 'Coordinar con la escuela la devolución del proyecto firmado.', 'Coordinar con la escuela la devolución del proyecto firmado.', '2026-03-02', '2026-03-07', 'Finalizada', 1, 'Alta', '2026-03-02 15:34:35', NULL, NULL, 19, NULL, 11, NULL, 'T', 0, 'T'),
    (32, 'Fijar cronograma y fechas de inicio de las prácticas', 'Fijar cronograma y fechas de inicio de las prácticas', '2026-03-02', '2026-03-06', 'Finalizada', 100, 'Alta', '2026-03-02 15:35:20', NULL, NULL, 21, 7, 11, NULL, 'T', 0, 'T'),
    (33, 'Designar tutores internos para el seguimiento pedagógico y técnico.', 'Designar tutores internos para el seguimiento pedagógico y técnico.', '2026-03-02', '2026-03-06', 'Finalizada', 100, 'Media', '2026-03-02 15:36:09', NULL, NULL, 20, 7, 11, NULL, 'T', 0, 'T'),
    (34, 'iniciar la inducción y capacitación redacción de cv y entrevistas laborales (a cargo de IPAP))', 'iniciar la inducción y capacitación redacción de cv y entrevistas laborales (a cargo de IPAP))', '2026-03-02', '2026-03-06', 'Finalizada', 100, 'Media', '2026-03-02 15:36:55', NULL, NULL, 21, 7, 11, NULL, 'T', 0, 'T'),
    (35, 'Convocatoria y postulaciones a las prácticas', 'Convocatoria y postulaciones a las prácticas', '2026-03-02', '2026-03-06', 'Finalizada', 100, 'Alta', '2026-03-02 15:37:51', NULL, NULL, 21, 7, 11, NULL, 'T', 0, 'T'),
    (36, 'Difusión institucional', 'Difusión institucional', '2026-03-02', '2026-03-06', 'Finalizada', 100, 'Media', '2026-03-02 15:38:47', NULL, NULL, 21, 7, 11, 35, 'T', 0, 'T'),
    (38, 'Iniciar las prácticas', 'Iniciar las prácticas', '2026-03-02', '2026-03-06', 'Finalizada', 100, 'Media', '2026-03-02 15:40:17', NULL, NULL, 21, 7, 11, NULL, 'T', 0, 'T'),
    (39, 'Presentación institucional y bienvenida', 'Presentación institucional y bienvenida', '2026-03-02', '2026-03-06', 'Finalizada', 100, 'Media', '2026-03-02 15:42:16', NULL, NULL, 21, 7, 11, 38, 'T', 0, 'T'),
    (49, 'Relevar cupos y perfiles solicitados en las áreas de la Agencia', 'Relevar cupos y perfiles solicitados en las áreas de la Agencia', '2026-03-02', '2026-03-28', 'Finalizada', 100, 'Media', '2026-03-02 17:36:54', NULL, NULL, 20, 7, 14, NULL, 'T', 0, 'T'),
    (50, 'Identificar estudiantes interesados en el Colegio Kloketen (Anexo 11).', 'Identificar estudiantes interesados en el Colegio Kloketen (Anexo 11).', '2026-03-02', '2026-03-28', 'En proceso', 1, 'Media', '2026-03-02 17:37:32', NULL, NULL, 21, 7, 14, NULL, 'T', 0, 'T'),
    (51, 'Armar el programa detallado de tareas y objetivos para el pasante.', 'Armar el programa detallado de tareas y objetivos para el pasante.', '2026-03-02', '2026-03-28', 'En proceso', 1, 'Media', '2026-03-02 17:38:00', NULL, NULL, 20, 7, 14, NULL, 'T', 0, 'T'),
    ...
    (56, 'Identificar contenidos para evitar superposiciones con trayectos existentes.', 'Identificar contenidos para evitar superposiciones con trayectos existentes.', '2026-03-02', '2026-03-28', 'Finalizada', 100, 'Media', '2026-03-02 17:45:56', NULL, NULL, 9, 7, 16, NULL, 'T', 0, 'T'),
    (57, 'Definir los trayectos formativos específicos para 2026', 'Definir los trayectos formativos específicos para 2026', '2026-03-02', '2026-03-28', 'Finalizada', 1, 'Media', '2026-03-02 17:47:24', NULL, NULL, 9, 7, 16, NULL, 'T', 0, 'T'),
    ...
    (101, 'Identificar instituciones para prácticas de Desarrollo Web fuera del Marte', 'Identificar instituciones para prácticas de Desarrollo Web fuera del Martes.', '2026-03-02', '2026-03-28', 'En proceso', 1, 'Media', '2026-03-02 19:11:11', NULL, NULL, 20, 7, 30, NULL, 'T', 0, 'T'),
    (102, 'Analizar perfiles de Técnico Superior que requieran plazas de práctica.', 'Analizar perfiles de Técnico Superior que requieran plazas de práctica.', '2026-03-02', '2026-03-28', 'En proceso', 1, 'Media', '2026-03-02 19:11:38', NULL, NULL, 20, 7, 30, NULL, 'T', 0, 'T'),
    (103, 'Validar con Supervisión de Educación Superior la viabilidad de las plazas.', 'Validar con Supervisión de Educación Superior la viabilidad de las plazas.', '2026-03-02', '2026-03-28', 'En proceso', 1, 'Media', '2026-03-02 19:12:07', NULL, NULL, 20, 7, 30, NULL, 'T', 0, 'T'),
    (104, 'Revisar el cronograma de ejecución y plazos de presentación formal.', 'Revisar el cronograma de ejecución y plazos de presentación formal.', '2026-03-02', '2026-03-28', 'Finalizada', 100, 'Media', '2026-03-02 19:16:13', NULL, NULL, 20, 7, 31, NULL, 'T', 1, 'T'),
    (105, 'Coordinar con la Unidad de Contrataciones el seguimiento del expediente.', 'Coordinar con la Unidad de Contrataciones el seguimiento del expediente.', '2026-03-02', '2026-03-28', 'Finalizada', 1, 'Media', '2026-03-02 19:16:46', NULL, NULL, 21, 7, 31, NULL, 'T', 2, 'T'),
    (106, 'Designar a los responsables técnicos para la certificación de hitos.', 'Designar a los responsables técnicos para la certificación de hitos.', '2026-03-02', '2026-03-28', 'En proceso', 1, 'Media', '2026-03-02 19:17:15', NULL, NULL, 9, 7, 31, NULL, 'T', 3, 'T'),
    ...
    (108, 'Cargar el cronograma detallado de acciones en el Drive compartido.', 'Cargar el cronograma detallado de acciones en el Drive compartido.', '2026-03-02', '2026-03-28', 'Finalizada', 1, 'Media', '2026-03-02 19:20:34', NULL, NULL, 21, 7, 32, NULL, 'T', 0, 'T'),
    ...
    (116, 'Diseñar programa de tutoría/acompañamiento para los postulantes.', 'Diseñar programa de tutoría/acompañamiento para los postulantes.', '2026-03-02', '2026-03-28', 'Finalizada', 1, 'Media', '2026-03-02 19:27:41', NULL, NULL, 20, 7, 34, NULL, 'T', 0, 'T'),
    (117, 'Gestionar el diseño y la impresión del banner para el aula en Tolhuin.', 'Gestionar el diseño y la impresión del banner para el aula en Tolhuin.', '2026-03-02', '2026-03-28', 'Finalizada', 1, 'Media', '2026-03-02 19:29:02', NULL, NULL, 19, NULL, 35, NULL, 'T', 0, 'T'),
    (118, 'Definir el cronograma de apertura del espacio a la comunidad.', 'Definir el cronograma de apertura del espacio a la comunidad.', '2026-03-02', '2026-03-28', 'Finalizada', 1, 'Media', '2026-03-02 19:29:46', NULL, NULL, 20, 7, 35, NULL, 'T', 0, 'T'),
    (119, 'Seleccionar las sesiones de Malvinas que actuarán como eje expositivo.', 'Seleccionar las sesiones de Malvinas que actuarán como eje expositivo.', '2026-03-02', '2026-03-28', 'Finalizada', 1, 'Media', '2026-03-02 19:30:12', NULL, NULL, 20, 7, 35, NULL, 'T', 0, 'T'),
    (120, 'Incorporar los ajustes técnicos surgidos de la reunión presencial al TDR.', 'Incorporar los ajustes técnicos surgidos de la reunión presencial al TDR.', '2026-03-02', '2026-03-28', 'Finalizada', 100, 'Media', '2026-03-02 19:34:10', NULL, NULL, 21, 7, 36, NULL, 'T', 0, 'T'),
    (121, 'Finalizar el presupuesto detallado y el cronograma de ejecución', 'Finalizar el presupuesto detallado y el cronograma de ejecución', '2026-03-02', '2026-03-28', 'Finalizada', 1, 'Media', '2026-03-02 19:34:40', NULL, NULL, 20, 7, 36, NULL, 'T', 0, 'T'),
    (122, 'Coordinar las pruebas de campo con alumnos del trayecto Quimiceros.', 'Coordinar las pruebas de campo con alumnos del trayecto Quimiceros.', '2026-03-02', '2026-03-28', 'Finalizada', 1, 'Media', '2026-03-02 19:35:16', NULL, NULL, 20, 7, 36, NULL, 'T', 0, 'T'),
    ...
    (137, 'Coordinar reunión de vinculación con "Punto" y docente de biomateriales.', 'Coordinar reunión de vinculación con "Punto" y docente de biomateriales.', '2026-03-02', '2026-03-28', 'Finalizada', 1, 'Media', '2026-03-02 19:49:02', NULL, NULL, 21, 7, 41, NULL, 'T', 0, 'T'),
    ...
    (144, 'Integrar a estudiantes del Colegio Martes en roles de asistencia técnica.', 'Integrar a estudiantes del Colegio Marte en roles de asistencia técnica.', '2026-03-02', '2026-03-28', 'En proceso', 1, 'Media', '2026-03-02 19:53:51', NULL, NULL, 4, 7, 43, NULL, 'T', 0, 'T'),
...
VALUES
    ...
    (37, 'Selección de perfiles y entrevistas (AIF)', 'Selección de perfiles y entrevistas (AIF)', '2026-03-02', '2026-03-30', 'Finalizada', 100, 'Baja', '2026-03-02 18:39:32', NULL, NULL, 21, 7, 11, 35, 'T', 0, 'T'),
    (181, 'Solicitar a Mariel Navarro estado de proyectos PFI 22/23', 'Solicitar a Mariel Navarro estado de proyectos PFI 22/23', '2026-03-06', '2026-03-31', 'Finalizada', 1, 'Media', '2026-03-06 22:52:01', NULL, NULL, 21, 7, 54, NULL, NULL, 1, 'T'),
    (183, 'Articular con Paola Rojas (admin)', 'Articular con Paola Rojas (admin)', '2026-03-06', '2026-03-31', 'Finalizada', 1, 'Media', '2026-03-07 02:08:15', NULL, NULL, 21, 7, 54, NULL, NULL, 3, 'T'),
...
INSERT INTO [dbo].[users_rol] ([id], [nombre], [descripcion], [trial197], [TRIAL426])
VALUES
...
INSERT INTO [dbo].[users_usuario] ([id], [nombre], [email], [password], [estado], [fecha_creacion], [rol_id], [area_id], [apellido], [secretaria_id], [trial197], [token_version], [TRIAL426])
VALUES
    (23, 'Andrea', 'aavergara@aif.gob.ar', 'pbkdf2_sha256$600000$wss9So8kNjBURLOsC086S6$8D8VthBVpztsrDyba7Npo0WXPFrCzX34BC0ARCEdewc=', 1, '2026-06-09 22:39:39', 2, NULL, 'Vergara', 13, NULL, 1, NULL),
    ...
    (6, 'horacio david', 'bogarin1983@gmail.com', 'pbkdf2_sha256$600000$Nrz9jUh3vnjIQfHm8dDT7f$8eOGsxNMw1O2H+j1PHS25pajMOs4r6Rt/tUqZKIpMlo=', 1, '2026-02-26 23:06:38', 1, NULL, 'bogarin', 7, 'T', 4, 'T'),
    (3, 'Usuario', 'carga@test.com', 'carga123', 1, '2026-02-26 17:01:37', 2, 2, 'Carga', NULL, 'T', 1, 'T'),
    (18, 'Demo2026', 'ejmplo2026@gmail.com', 'pbkdf2_sha256$600000$loMKRf9umSB1z84jOH0mtG$x7obUdHw31vPz8o9qCFrR384GdOL6aWTEutBYRZHWGE=', 1, '2026-03-19 18:26:11', 1, NULL, 'ejemplo', NULL, NULL, 1, NULL),
    (20, 'Elida del Valle', 'erechi@aif.gob.ar', 'pbkdf2_sha256$600000$AT6PV3tXsdRCO3x7wa54XE$W2DiN9SE9ECWnZqR1fAdQCJz6d7fxGXb47FKS1YmL/s=', 1, '2026-03-27 16:38:14', 1, NULL, 'Rechi', 7, NULL, 1, NULL),
    ...
    (21, 'Jesica B', 'jcasadidio@aif.gob.ar', 'pbkdf2_sha256$600000$vIgDYqZQmsnLuHvkDDEHK5$ZGnyB+y7+m4OUDc6Br0dXp3IGBE0f89g5X9G1i9i35g=', 1, '2026-03-27 20:51:00', 2, NULL, 'Casadidio', 7, NULL, 1, NULL),
    (19, 'Jesica', 'jesicabcasadidio@gmail.com', 'pbkdf2_sha256$600000$ZuillrKlsXoLSVHnQ8S3XG$ok7CG9sjzCAIO9L/lwN4FGTsTPDm9DX4F83dBWA6Izc=', 1, '2026-03-27 15:49:08', 1, NULL, 'casadidio', NULL, NULL, 2, NULL),
    ...
    (22, 'julieta', 'jzeballos@tierradelfuego.gob.ar', 'pbkdf2_sha256$600000$b2rtizvlAJf7ct87FC1f62$henSfFHi50/aubOlfcwLfvlkPne5J98+Tay6kO7BFFA=', 1, '2026-06-09 17:17:29', 1, NULL, 'zeballos', 7, NULL, 1, NULL),
    ...
    (25, 'Maximiliano', 'maxtorres@aif.gob.ar', 'pbkdf2_sha256$600000$gwy87STH9Uy4qYg1JXPFqo$3/+WHDMzENZ7CFh/QyUE/l9pHH3Mpu4VW6YG38DKSeY=', 1, '2026-06-09 22:42:17', 1, NULL, 'Torres', 7, NULL, 1, NULL),
    (5, 'Pepe', 'pepe@test.com', 'carga123', 0, '2026-02-26 17:05:44', 2, 2, 'García', NULL, 'T', 1, 'T'),
    (26, 'Renata', 'rbonetto@tierradelfuego.gob.ar', 'pbkdf2_sha256$600000$wiKFrsgvGcwEc0CD1gHu2K$dudnXF92AeQnD6nYSgX3obIfzCmA1iuhofAPi6sM7XI=', 1, '2026-06-10 17:07:57', 2, NULL, 'Bonetto', 22, NULL, 1, NULL),
    (24, 'Estefanía', 'rerosas@aif.gob.ar', 'pbkdf2_sha256$600000$9tHSXWBPuoY4uggNqY9SyY$4G569UY0dnV7+K4BEFSg3y4NsfU/zOSOCC7oSUDkHwo=', 1, '2026-06-09 22:41:04', 1, NULL, 'Rosas', 13, NULL, 1, NULL),
