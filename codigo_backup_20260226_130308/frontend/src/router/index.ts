...
router.beforeEach((to, _from, next) => {
  loadingTimer = setTimeout(() => useLoading().show(), 120)
  ...
  const restrictedForVisualizador = ['/areas', '/usuarios', '/roles', '/cargar', '/secretarias', '/backup-restore']
  const restrictedForCarga = ['/proyectos', '/tareas', '/areas', '/usuarios', '/roles', '/avances-por-area', '/avances-por-secretaria', '/planificacion', '/secretarias', '/backup-restore']
