...
<template>
  <div class="page">
    ...
    <p v-if="!secretarias.length" class="empty-msg">No hay secretarías cargadas.</p>
    <p v-else-if="!secretariasFiltradas.length" class="empty-msg">No hay secretarías que coincidan con el filtro.</p>
    ...
    <div v-if="showForm" class="modal-overlay" @click.self="showForm = false">
      <div class="modal">
        ...
        <form @submit.prevent="save">
          <label>Código</label>
          <input v-model="form.codigo" placeholder="Ej: EC, CYT" required :readonly="!!editingId" />
          <label>Nombre</label>
