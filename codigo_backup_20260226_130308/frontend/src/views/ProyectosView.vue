  ...
  <div class="page">
    ...
    <div v-else-if="proyectosFiltrados.length" class="table-wrapper">
      <table class="table">
        ...
        <tbody>
          <tr v-for="p in proyectosFiltrados" :key="(p.id as number)">
            <td>
    ...
    <p v-else-if="!proyectos.length" class="empty-msg">No hay proyectos. Cree uno con el botón anterior.</p>
    <p v-else class="empty-msg">No hay proyectos que coincidan con la búsqueda.</p>
    ...
    <div v-if="showForm" class="modal-overlay" @click.self="showForm = false">
      <div class="modal">
        ...
        <form @submit.prevent="save">
          ...
          <select v-model.number="form.usuario_responsable" required>
